...
import withSectionWrapper, { ReportElementProps } from "./withSectionWrapper"
...
describe("withSectionWrapper HOC", () => {
  it("renders without crashing", () => {
    ...
    const WithHoc = withSectionWrapper(testComponent)
    // @ts-ignore
  ...
  it("should render a component wrapped with FullScreenWrapper", () => {
    ...
    const sectionWrapper = wrapper.find(SectionWrapper)
  })
